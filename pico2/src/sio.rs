...
pub struct CoreSpecificSio<'a> {
    pub cpu_id: bool,
    pub mailbox: &'a Fifo,
    pub spinlock: &'a SpinLock,
    pub doorbell: &'a DoorBell,
    pub timer: &'a RiscVPlatformTimer,
    pub gpio: &'a Gpio,
    pub interpolator: &'a [Interpolator; 4],
    pub tmds: &'a [TmdsEncoder; 2],
}
